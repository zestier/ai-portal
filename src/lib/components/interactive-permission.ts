...
export type ScopeChoice =
  "this-exact" | "this-directory" | "tool-kind" | "tool-any" | "everything";
...
export type PermissionShortcut =
  "none" | "deny" | "allow-once" | "allow-always";
...
export function buildPermissionGrantScope(
  ...
  switch (choice) {
    ...
    case "this-directory":
      ...
      if (!isFilesystemPermissionKind(kind))
