<script lang="ts">
	...
	import { imageLightbox, closeImageLightbox } from '$lib/client/image-lightbox.svelte';
</script>
...
>
	<div class="lightbox">
		<div class="bar">
			<a class="btn sm ghost" href={imageLightbox.src} target="_blank" rel="noopener noreferrer">
				Open original
			</a>
			<button
