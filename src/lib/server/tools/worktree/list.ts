...
export function buildWorktreeListTool(ctx: { userId: number; conversationId: number }): PortalTool {
	...
	return {
		name: 'worktree_list',
		description: 'List the PORTAL worktree leases this conversation currently holds.',
		promptGuidelines: [
