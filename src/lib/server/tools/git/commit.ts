...
import { CommitBody, CommitSubject, CommitTrailers } from '../commit-message-args';
import {
...
export function buildGitCommitTools(cwd: string, ctx?: WorktreeToolContext): PortalTool[] {
