import type { ApprovalMode, PermissionPolicy, PortalEvent, SessionMode } from '$lib/types';
...
export function buildPermissionTools(opts: BuildPermissionToolsOpts): PortalTool[] {
	return [buildCapabilitiesTool(opts), buildGrantRequestTool(opts), buildForceRetryTool(opts)];
}
