  ...
  return [
    {
      ...
      parameters: {
        ...
        properties: {
          loopType: {
            type: "string",
            description: "Optional loop type filter.",
          },
          limit: {
            type: "number",
            description: "Open loops 1-50, default 20.",
          },
          fields: FIELDS_PARAM,
        },
      ...
      async handler(args) {
        ...
        const projected = project(
          openLoops,
          projectOptions(parsed.fields, OPEN_LOOP_KEEP),
        );
        return ok(
          withOmitted({ openLoops: projected.value }, projected.omitted),
          summary,
        );
      },
    },
