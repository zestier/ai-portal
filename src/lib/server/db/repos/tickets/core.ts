  ...
  return {
    ...
    sourceConversationId:
      r.source_conversation_id === null
        ? null
        : conversationId.encode(r.source_conversation_id),
    sourceMessageId:
      r.source_message_id === null
        ? null
        : messageId.encode(r.source_message_id),
...
export function update(
  ...
  getDb().transaction(() => {
    ...
    if (patch.blockedBy !== undefined)
      reconcileEdges(userId, intId, patch.blockedBy, "blockedBy");
    if (patch.blocks !== undefined)
      reconcileEdges(userId, intId, patch.blocks, "blocks");
  })();
  notifyTicketMutation({
    userId,
