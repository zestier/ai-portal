...
import type { PortalExtension, PortalExtensionKind, PortalExtensionStatus } from '$lib/types';
...
export function list(userId: number, opts: ListOptions = {}): PortalExtension[] {
...
export function get(userId: number, id: string | number): PortalExtension | null {
	const row = getDb()
