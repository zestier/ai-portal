...
export type ShadowResolutionSource =
  "prompt-grant" | "prompt-policy" | "auto-approve";
...
function normalizeResolutionSource(
  source: string | null,
): ShadowResolutionSource | null {
  return source === "prompt-grant" ||
